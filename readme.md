...
Пункт `5. 🔄 Обновить списки` обновляет только ipset-наборы и сохраняет счётчик отбитых атак. Пункт `6. ⬆️ Обновить rkn-guard и меню` скачивает свежий бинарник и скрипт меню, также без сброса счётчиков.
